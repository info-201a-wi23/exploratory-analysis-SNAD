...
ggplot(data = Life_expectancy_per_region, aes(x = as.character(WHR_2021.Regional.indicator), y = WHR_2021.Healthy.life.expectancy, fill = as.character(WHR_2021.Regional.indicator))) +
  geom_boxplot()+
